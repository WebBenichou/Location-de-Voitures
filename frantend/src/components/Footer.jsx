            ...
            <Row className="g-4">
                ...
                <Col lg={3} md={6} className="mb-4 mb-md-0">
                    ...
                    <div className="social-icons">
                        <a href="https://www.facebook.com/redouane.redouane.874797" aria-label="Facebook" className="text-primary me-3">
                            <FaFacebook className="fs-5" />
                        </a>
                        <a href="https://vm.tiktok.com/ZMBbv4fUY/" aria-label="Tiktok" className="text-light me-3">
                            <FaTiktok className="fs-5" />
                        </a>
                        <a href="https://www.instagram.com/dev_web_benichou?igsh=YzljYTk1ODg3Zg==" aria-label="Instagram" className="text-light me-3">
                            <FaInstagram className="fs-5" />
                        </a>
                        <a href="https://github.com/WebBenichou?tab=repositories" aria-label="GitHub" className="text-light me-3">
