...
const Accueil = ({ voitures }) => {
    const featuredCars = voitures.slice(0, 3); // Affiche les 3 premières voitures
                ...
                <div className="row">
                    {featuredCars.map(voiture => (
                        <div key={voiture._id} className="col-md-4 mb-4">
                            <div className="card">
                                <img src={voiture.image} className="card-img-top" alt={voiture.marque} />
                                <div className="card-body">
                                    <h5 className="card-title">{voiture.marque} {voiture.modele}</h5>
                                    <p className="card-text">{voiture.prix}€/jour</p>
